...
const Header = () => {
  ...
  return (
    <header className={`sticky top-0 z-50 h-18 bg-gray-800/70 backdrop-blur-md shadow-md border-b border-b-slate-700 transition-transform duration-300 ${isHeaderVisible ? 'translate-y-0' : '-translate-y-full'}`}>
      <div className="container mx-auto px-4 pt-1 pb-2 flex items-center justify-between">
        
        {/* Mobile Menu Button */}
        <button
          className="md:hidden text-gray-300 hover:text-gray-100 mr-4"
          onClick={toggleMenu}
        ...
        {/* Plus Icon */}
        <button className="text-gray-300 hover:text-gray-100 ml-4">
